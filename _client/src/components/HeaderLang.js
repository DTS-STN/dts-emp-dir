  ...
  render() {
    ...
    return (
      ...
      <section id="wb-lng" className="text-right">
        <h2 className="wb-inv"><Trans>Language selection</Trans></h2>
        <div className="row">
                ...
                <ul className="list-inline margin-bottom-none">
                    <li>
                      { this.getNewLanguage() === 'fr' 
                        ? 
                        <a href="/#english" lang='en' onClick={() => this.handleClick(lang)} >Français</a>
                        :   
                        <a href="/#français" lang="fr" onClick={() => this.handleClick(lang)} >English</a>
                      }
                    </li>
                </ul>
            </div>
