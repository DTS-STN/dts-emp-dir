  ...
  render() {
    ...
    return (
      ...
      <details className="brdr-0">
        <summary className="btn btn-default text-center">Report a problem or mistake on this page</summary>
        <div className="clearfix"></div>
        <div className="well row">
          <div>
            <div className="gc-rprt-prblm">
              <div className="gc-rprt-prblm-frm gc-rprt-prblm-tggl" id="wb-auto-6">			
                <form id="gc-rprt-prblm-form" action="/gc/services/generateemail" method="post">
                  <input type="hidden" name="pageTitle" value="Departments and agencies" />
                  <input type="hidden" name="submissionPage" value="/content/canadasite/en/government/dept.html" />
                  ...
                  <fieldset>
                    <legend><span className="field-name">Please select all that apply:</span></legend>
                  ...
                  <button data-wb5-click="postback@#gc-rprt-prblm-form@" type="submit" className="btn btn-primary wb-toggle wb-init wb-toggle-inited" data-toggle="{&quot;stateOff&quot;: &quot;hide&quot;, &quot;stateOn&quot;: &quot;show&quot;, &quot;selector&quot;: &quot;.gc-rprt-prblm-tggl&quot;}" aria-controls="wb-auto-6 wb-auto-7">
                    Submit
                  </button>
                </form>
              </div>
              <div className="gc-rprt-prblm-thnk gc-rprt-prblm-tggl hide" id="wb-auto-7">
                <h3>Thank you for your help!</h3>
                <p>You will not receive a reply. For enquiries,&nbsp;
                  <a href="https://www.canada.ca/en/contact/index.html">contact us</a>.
                </p>
              </div>
            </div>
          </div>
